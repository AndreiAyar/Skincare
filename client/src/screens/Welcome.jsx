    ...
    <>
      ...
      <View style={styles.container}>
        ...
        <Text style={styles.text_main}>
          Your skin is safe.{" "}
          <Text style={styles.text_secondary}>Beautiful.</Text>
        </Text>
        <Text style={styles.text_third}>Enjoy the experience.</Text>
        <Image
          style={styles.main_logo}
          source={require("../resources/logoskin.png")}
        />
        <View style={styles.auth}>
          <TouchableOpacity
            style={styles.auth_buttons_shadow}
            onPress={() => (
              Vibration.vibrate(500), navigation.navigate("Login")
            )}
          >
            <LinearGradient
          ...
          <TouchableOpacity
            style={styles.auth_buttons_shadow}
            onPress={() => (
              Vibration.vibrate(500), navigation.navigate("Signup")
            )}
          >
            <LinearGradient
              colors={["#5C258D", "#4389A2", "#5C258D"]}
