  ...
  function messageHandler(message) {
    switch (message) {
      ...
      case "confirmPassErr":
        setMessage((prevState) => ({
          ...prevState,
          confirmPassErr: (prevState.confirmPassErr =
            "Confirmation password must be 6 characters long."),
        }));
        break;
      case "passwordMissmatchErr":
        setMessage((prevState) => ({
          ...prevState,
          passwordMissmatchErr: (prevState.passwordMissmatchErr =
      ...
      >
        ...
        <View style={{ alignContent: "center" }}>
          ...
          <Text
            style={{
              alignSelf: "center",
              fontWeight: "bold",
              color: data && data.register.success ? "#3ec1cf" : "#c21253",
            }}
          >
            {allTrue(allowRegister) && data && data.register.message}
          </Text>
        </View>
        ...
        <View style={styles.input_container}>
          ...
          <TextInput
            ...
            style={[
              styles.input,
              userName != null && userName.length == 0 && styles.input_empty,
            ]}
