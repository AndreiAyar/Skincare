        ...
        data.map(({ id, type, source }, index) =>
            <View  key={index} style={styles.container}>
                <View style={styles.type}>
                    ...
                    <Text style={{ fontSize: 15, padding: 5, fontWeight: 'bold' }}>{type}</Text>
                </View>
                <View style={styles.banner}>
                    ...
                    <View style={styles.inner_text}>
                        <Text style={{ width: 100, textAlign: 'left', color: '#A5A4AD', paddingBottom: 2, fontSize: 12 }} numberOfLines={2} >{type}</Text>
                        <Text style={{ width: 100, textAlign: 'left', fontSize: 14 }} numberOfLines={2} >Textdadada</Text>
